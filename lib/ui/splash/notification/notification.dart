          ...
          GestureDetector(
            onTap: (){
              Navigator.push(context, MaterialPageRoute(
                builder: (_){
                  return JobDetail(title: "Job Details", name: Constants.NOTIFICATION_FILTER,);
                }
              ));
            },
            child: Container(
...
//            color: Colors.white,
          ...
          actions: <Widget>[
            ...
            CupertinoDialogAction(
              child: const Text('Yes, decline', style: TextStyle(
                  color: Colors.green
              )),
              onPressed: () {
...
//            color: Colors.white,
          ...
          actions: <Widget>[
            ...
            CupertinoDialogAction(
              child: const Text('Yes, Accept',  style: TextStyle(
                  color: Colors.green
              ),),
              onPressed: () {
                Navigator.pop(context, 'Allow');

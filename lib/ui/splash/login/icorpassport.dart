...
class AddIcOrPassport extends StatefulWidget {
  @override
  _AddIcOrPassportState createState() => _AddIcOrPassportState();
}

class _AddIcOrPassportState extends State<AddIcOrPassport> with TickerProviderStateMixin, ImagePickerListener {

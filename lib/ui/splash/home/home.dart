      ...
      bottomNavigationBar:  BottomNavigationBar(
        items:  <BottomNavigationBarItem>[
          BottomNavigationBarItem(
            ...
            icon: Image.asset("assets/images/home_active.png", width: 30, height: 30,),
            title: Text('Home'),
          ),
          BottomNavigationBarItem(
            icon: Image.asset("assets/images/notification_bottom.png", width: 30, height: 30,),
            title: Text('Notification'),
          ),
          BottomNavigationBarItem(
            icon: Image.asset("assets/images/jobs.png", width: 30, height: 30,),
            title: Text('Jobs'),
          ),
          BottomNavigationBarItem(
            icon: Image.asset("assets/images/chat.png", width: 30, height: 30,),
        ...
        child: Column(
          ...
          children: <Widget>[
                    ...
                    child: Row(
                        children: <Widget>[
                          Container(
                            ...
                            child: Text(
                              "See All",
                              style: TextStyle(color: Color.fromRGBO(19, 153, 159, 1.0)),
                            ),
                          ),
                          Container(
            ...
            Row(
              ...
              children: <Widget>[
                Image.asset("assets/images/group_403.png" , width: MediaQuery.of(context).size.width/2.5,),
                Image.asset("assets/images/message.png" , width: MediaQuery.of(context).size.width/2.5,)
               ...
               children: <Widget>[
                 ...
                 Container(
                   ...
                   child: Column(
                     ...
                     children: <Widget>[
                       Text("Help"),
                       Text("Chat with us if you need help", style: TextStyle(
